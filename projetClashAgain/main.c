...
/*/
        ...
        z=creeChevalier(4,1);
        t=creeChevalier(5,2);
        x->couleur=player2.couleurJoueur;
        y->couleur=player2.couleurJoueur;
        z->couleur=player2.couleurJoueur;
        t->couleur=player2.couleurJoueur;
/**/
//creeTour  creeTourRoi
...
/*/
        player2.listeU =AjouterUnite(player2.listeU,x);
        player2.listeU =AjouterUnite(player2.listeU,t);
        player2.listeU =AjouterUnite(player2.listeU,z);
        player2.listeU =AjouterUnite(player2.listeU,y);
/**/
        ...
        while ( cont != 0 ){   //VOUS DEVEZ GERER (DETECTER) LA FIN DU JEU -> tourRoiDetruite
                ...
                i++;
                if(i==10){
                        list_cible=GetAllUniteInTplateuUPgrade(jeuUpgrade,LARGEURJEU,HAUTEURJEU);
                        affiche(list_cible);
                }
                /**/
                ///********************* fin NOUVEAUTE ***************************
